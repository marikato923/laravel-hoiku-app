...
@section('breadcrumbs')
    <nav class="mb-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.children.show', $child->id) }}">園児の情報</a></li>
...
@section('content')
        <div class="container py-2 kodomolog-app-container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-8 col-sm-8 mx-auto">
                    <div class="wrapper w-100" style="max-width: 80%; margin: 0 auto;">
                        
                        <h3 class="text-center mb-4">園児情報の編集</h3>
                        <hr class="mb-4">
                        
                        <form action="{{ route('admin.children.update', $child->id) }}" method="POST" enctype="multipart/form-data" style="max-width: 600px; margin: 0 auto;">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="text-center mb-5">
                                <button type="submit" class="btn register-btn shadow-none px-4 mt-3 mb-3">更新</button>
                            </div>
                        </form>
                    </div>
                </div>
